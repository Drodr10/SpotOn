...
CREATE OR REPLACE FUNCTION "public"."get_nearby_listings"("user_lat" double precision, "user_long" double precision, "max_meters" double precision DEFAULT 16093.4) RETURNS SETOF "public"."listings"
...
ALTER FUNCTION "public"."get_nearby_listings"("user_lat" double precision, "user_long" double precision, "max_meters" double precision) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."handle_update_user_email"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
...
ALTER FUNCTION "public"."handle_update_user_email"() OWNER TO "postgres";
...
CREATE OR REPLACE TRIGGER "on_profile_email_update" AFTER UPDATE OF "email" ON "public"."profiles" FOR EACH ROW EXECUTE FUNCTION "public"."handle_update_user_email"();



ALTER TABLE ONLY "public"."conversations"
    ADD CONSTRAINT "conversations_owner_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "public"."profiles"("id");



ALTER TABLE ONLY "public"."conversations"
    ADD CONSTRAINT "conversations_renter_id_fkey" FOREIGN KEY ("renter_id") REFERENCES "public"."profiles"("id");



ALTER TABLE ONLY "public"."conversations"
    ADD CONSTRAINT "conversations_reservation_id_fkey" FOREIGN KEY ("reservation_id") REFERENCES "public"."reservations"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."reservations"
    ADD CONSTRAINT "reservations_renter_id_fkey" FOREIGN KEY ("renter_id") REFERENCES "public"."profiles"("id");



CREATE POLICY "Owner Access" ON "public"."listing_images" USING (("auth"."uid"() IN ( SELECT "listings"."owner_id"
   FROM "public"."listings"
  WHERE ("listings"."id" = "listing_images"."listing_id"))));



CREATE POLICY "Public Access" ON "public"."listing_images" FOR SELECT USING (true);
...
CREATE POLICY "conversations_participants_delete" ON "public"."conversations" FOR DELETE TO "authenticated" USING ((("renter_id" = ( SELECT "auth"."uid"() AS "uid")) OR ("owner_id" = ( SELECT "auth"."uid"() AS "uid"))));



CREATE POLICY "conversations_participants_insert" ON "public"."conversations" FOR INSERT TO "authenticated" WITH CHECK ((("renter_id" = ( SELECT "auth"."uid"() AS "uid")) OR ("owner_id" = ( SELECT "auth"."uid"() AS "uid"))));



CREATE POLICY "conversations_participants_select" ON "public"."conversations" FOR SELECT TO "authenticated" USING ((("renter_id" = ( SELECT "auth"."uid"() AS "uid")) OR ("owner_id" = ( SELECT "auth"."uid"() AS "uid"))));



CREATE POLICY "conversations_participants_update" ON "public"."conversations" FOR UPDATE TO "authenticated" USING ((("renter_id" = ( SELECT "auth"."uid"() AS "uid")) OR ("owner_id" = ( SELECT "auth"."uid"() AS "uid")))) WITH CHECK ((("renter_id" = ( SELECT "auth"."uid"() AS "uid")) OR ("owner_id" = ( SELECT "auth"."uid"() AS "uid"))));
...
CREATE POLICY "listings_owner_delete" ON "public"."listings" FOR DELETE TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "owner_id"));



CREATE POLICY "listings_owner_insert" ON "public"."listings" FOR INSERT TO "authenticated" WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "owner_id"));



CREATE POLICY "listings_owner_update" ON "public"."listings" FOR UPDATE TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "owner_id")) WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "owner_id"));



CREATE POLICY "listings_public_select" ON "public"."listings" FOR SELECT USING (("is_active" = true));
...
CREATE POLICY "messages_conversation_participants_delete" ON "public"."messages" FOR DELETE TO "authenticated" USING (("sender_id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "messages_conversation_participants_insert" ON "public"."messages" FOR INSERT TO "authenticated" WITH CHECK (((EXISTS ( SELECT 1
...
CREATE POLICY "messages_conversation_participants_select" ON "public"."messages" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."conversations" "c"
  WHERE (("c"."id" = "messages"."conversation_id") AND (("c"."renter_id" = ( SELECT "auth"."uid"() AS "uid")) OR ("c"."owner_id" = ( SELECT "auth"."uid"() AS "uid")))))));



CREATE POLICY "messages_conversation_participants_update" ON "public"."messages" FOR UPDATE TO "authenticated" USING (("sender_id" = ( SELECT "auth"."uid"() AS "uid"))) WITH CHECK (("sender_id" = ( SELECT "auth"."uid"() AS "uid")));
...
CREATE POLICY "profiles_manage_own" ON "public"."profiles" TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "id")) WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "id"));
...
CREATE POLICY "reservations_parties_select" ON "public"."reservations" FOR SELECT TO "authenticated" USING ((("renter_id" = ( SELECT "auth"."uid"() AS "uid")) OR ("listing_id" IN ( SELECT "listings"."id"
   FROM "public"."listings"
  WHERE ("listings"."owner_id" = ( SELECT "auth"."uid"() AS "uid"))))));



CREATE POLICY "reservations_renter_insert" ON "public"."reservations" FOR INSERT TO "authenticated" WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "renter_id"));



CREATE POLICY "reservations_update_status" ON "public"."reservations" FOR UPDATE TO "authenticated" USING ((("renter_id" = ( SELECT "auth"."uid"() AS "uid")) OR ("listing_id" IN ( SELECT "listings"."id"
   FROM "public"."listings"
  WHERE ("listings"."owner_id" = ( SELECT "auth"."uid"() AS "uid")))))) WITH CHECK ((("renter_id" = ( SELECT "auth"."uid"() AS "uid")) OR ("listing_id" IN ( SELECT "listings"."id"
   FROM "public"."listings"
  WHERE ("listings"."owner_id" = ( SELECT "auth"."uid"() AS "uid"))))));
...
GRANT ALL ON FUNCTION "public"."get_nearby_listings"("user_lat" double precision, "user_long" double precision, "max_meters" double precision) TO "anon";
GRANT ALL ON FUNCTION "public"."get_nearby_listings"("user_lat" double precision, "user_long" double precision, "max_meters" double precision) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_nearby_listings"("user_lat" double precision, "user_long" double precision, "max_meters" double precision) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."handle_update_user_email"() TO "anon";
GRANT ALL ON FUNCTION "public"."handle_update_user_email"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."handle_update_user_email"() TO "service_role";
